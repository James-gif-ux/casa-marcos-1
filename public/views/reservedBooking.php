                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                ...
                                <?php foreach ($reservation as $res): ?>
                                    <tr class="text-gray-700 dark:text-gray-400 <?php echo $hasMultipleBookings ? 'bg-yellow-50' : ''; ?>"> 
                                        <td class="px-4 py-3 text-center" style="padding: 25px;"><?php echo $rowNumber ++;?></td>
                                        <td class="px-4 py-3 text-center"><?php echo htmlspecialchars($res['services_name'] ?? 'N/A'); ?></td>
                                            ...
                                            <?php if (isset($res['reservation_id'])): ?>
                                                <?php if ($res['status'] === 'pending'): ?>
                                                    <a href="javascript:void(0)" onclick="showConfirmModal(
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#0b5306" class="bi bi-check-square-fill" viewBox="0 0 16 16">
                                                ...
                                                <?php if ($res['status'] === 'pending'): ?>
                                                   <a href="../pages/approvedBooking.php?reservation_id=<?php echo htmlspecialchars($res['reservation_id']); ?>&action=cancel"
                                                    class="btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-square" viewBox="0 0 16 16">
